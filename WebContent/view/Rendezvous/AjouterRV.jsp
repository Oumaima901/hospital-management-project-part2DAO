...
<ul class="sidebar">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
 <form method='POST' action='./AjouterRDV'>
 
  <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Date</label>
                          <input id='txtdate' name='txtdate' type ="date"  required='required' class="form-control" />
                        </div>
                      </div>
 ...
 <div class="col-md-6">
	...
	<div class="row">
                      <div class="col-md-12">
                         <div class="form-group">
                          <label class="bmd-label-floating">Nom du patient:</label>

	
	<div class="dropdown">
	
	<select id="txtpatient" name="txtpatient" class="form-control" style="width: 250px;">
